...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Data Calon Istri</h1>
    </div>
    <div class="table-responsive small">
        <!-- Tombol untuk menambahkan data calon suami baru -->
        <a class="btn btn-primary mb-4" href="cais_tambah.php">Tambah Calon Istri</a>
        <div class="card">
            <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        $data = mysqli_query($koneksi, "SELECT * FROM calon_istri");
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo $d['noktp_cais']; ?></td>
                                <td><?php echo $d['tempat_lahir']; ?></td>
                                <td><?php echo $d['tanggal_lahir']; ?></td>
                                <td><?php echo $d['alamat_cais']; ?></td>
                                <td><?php echo $d['pekerjaan_cais']; ?></td>
                                <td><?php echo $d['status_cais']; ?></td>
                                <td>
                                    <a class="btn btn-warning" href="cais_edit.php?id=<?php echo $d['id_cais']; ?>">EDIT</a>
                                    <a class="btn btn-danger" href="cais_hapus.php?id=<?php echo $d['id_cais']; ?>">HAPUS</a>
                                </td>
                            </tr>
                        <?php
                        }
