...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Data Calon Suami</h1>
    </div>
    <div class="table-responsive small">
        <!-- Tombol untuk menambahkan data calon suami baru -->
        <a class="btn btn-primary mb-4" href="cami_tambah.php">Tambah Calon Suami</a>
        <div class="card">
            <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        $data = mysqli_query($koneksi, "SELECT * FROM calon_suami");
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo $d['status_cami']; ?></td>
                                <td>
                                    <a class="btn btn-warning" href="cami_edit.php?id=<?php echo $d['id_cami']; ?>">EDIT</a>
                                    <a class="btn btn-danger" href="cami_hapus.php?id=<?php echo $d['id_cami']; ?>">HAPUS</a>
                                </td>
                            </tr>
                        <?php
                        }
