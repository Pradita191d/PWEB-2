...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Tambah Data Calon Suami</h1> <!-- Judul halaman -->
    </div>
        ...
        <form method="post" action="cami_aksi.php"> <!-- Form untuk menambahkan data mata kuliah dengan mengirimkan data ke halaman tambahmatkul_aksi.php -->
            <table>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="no_ktp"></td> <!-- Input field untuk memasukkan nama mata kuliah -->
                </tr>
                <tr>
                    <td>Tempat lahir</td> <!-- Label input untuk semester mata kuliah -->
                    <td><input type="text" name="tpt_lahir"></td> <!-- Input field untuk memasukkan semester mata kuliah -->
                </tr>
                <tr>
                    <td>Tanggal lahir</td> <!-- Label input untuk jumlah SKS mata kuliah -->
                    <td><input type="date" name="tgl_lahir"></td> <!-- Input field untuk memasukkan jumlah SKS mata kuliah -->
                </tr>
                <tr>
                    <td>Alamat</td> <!-- Label input untuk jumlah SKS mata kuliah -->
                    <td><input type="text" name="alamat"></td> <!-- Input field untuk memasukkan jumlah SKS mata kuliah -->
                </tr>
                <tr>
                    <td>Pekerjaan</td> <!-- Label input untuk jumlah SKS mata kuliah -->
                    <td><input type="text" name="pekerjaan"></td> <!-- Input field untuk memasukkan jumlah SKS mata kuliah -->
                </tr>
                <tr>
                    <td>Status</td> <!-- Label input untuk status -->
                    <td>
                        <select name="status_cami"> <!-- Dropdown untuk memilih status -->
