...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div class="table-responsive small">
        ...
        <a class="btn btn-primary mb-4" href="user_tambah.php">Tambah User</a>
        <div class="card">
            <div class="card-body">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-warning" href="user_edit.php?id=<?php echo $d['id']; ?>">EDIT</a>
                                    <a class="btn btn-danger" href="user_hapus.php?id=<?php echo $d['id']; ?>">HAPUS</a>
                                </td>
                            </tr>
                        <?php
                        }
